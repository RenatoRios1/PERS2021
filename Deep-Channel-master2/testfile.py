...
loaded_model = load_model('FiveChannelnmn_oversampled_deepchanel6_5.h5', custom_objects={
...
print("Length of target_train: " + str(len(target_train)))

print("Length of idatasetq: " + str(len(idataset_q)))
...
print("Length of idatasetq" + str(idataset_q2))
...
# #RENATOs Plot for 1 Open Channel
# #Raw Data Plot
# plt.figure(figsize=(30, 6))
# plt.plot(dataset[lenny:ulenny, 1], color='blue', label="the raw data")
# plt.title('Raw Data')
...
# plt.plot(c[lenny:ulenny], color='red', label="predicted idealisation")
# # line,=plt.plot(c[:lenny], color='red', label="predicted idealisation")
# plt.title('Deep Channel Idealisation 1 Channel')
# plt.ylabel('No. Open Channels')
# plt.yticks([0,1])
# plt.legend(loc = 'best')
# plt.show()
...
# #QuB2 Plot 
# plt.figure(figsize=(30, 6))
# plt.plot(idataset_q2[lenny:ulenny], color='darkgreen', label="QuB2 idealisation")
# plt.title('QuB2 ONE Channel')
# plt.ylabel('No. Open Channels')
# plt.yticks([0,1])
# plt.legend(loc = 'best')
# plt.show()

#RENATOs Plot for 5 Open Channels
#Raw Data Plot
plt.figure(figsize=(30, 6))
plt.plot(dataset[lenny:ulenny, 1], color='blue', label="the raw data")
plt.title('Raw Data')
